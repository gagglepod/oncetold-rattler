...
- –task: Whether you want to transcribeor translate (default: Transcribe). Transcribe does voice recognition whereas Translate changes from one language to another

- –language: Specify the language in the audio. If None provided, language detection will be done.
